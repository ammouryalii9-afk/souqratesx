...
export const getClaimRichAdsRewardUrl = () => {




  return `/api/earn/richads/reward`
}

/**
 * @summary Credit points for a completed RichAds ad view (button-triggered, client-trusted cooldown + daily cap)
 */
export const claimRichAdsReward = async ( options?: RequestInit): Promise<EarnRewardResult> => {

  return customFetch<EarnRewardResult>(getClaimRichAdsRewardUrl(),
  {
    ...options,
    method: 'POST'
...
export const getClaimRichAdsRewardMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof claimRichAdsReward>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof claimRichAdsReward>>, TError,void, TContext> => {

const mutationKey = ['claimRichAdsReward'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof claimRichAdsReward>>, void> = () => {


          return  claimRichAdsReward(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ClaimRichAdsRewardMutationResult = NonNullable<Awaited<ReturnType<typeof claimRichAdsReward>>>

    export type ClaimRichAdsRewardMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Credit points for a completed RichAds ad view (button-triggered, client-trusted cooldown + daily cap)
 */
export const useClaimRichAdsReward = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof claimRichAdsReward>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof claimRichAdsReward>>,
        TError,
        void,
        TContext
      > => {
      return useMutation(getClaimRichAdsRewardMutationOptions(options));
    }
