...
import { AdminTikTokCampaigns } from "./AdminTikTokCampaigns";
...
type Tab = "overview" | "analytics" | "anticheat" | "providers" | "live" | "users" | "squads" | "pixels" | "arcade" | "competitions" | "tiktok" | "broadcast" | "ads" | "star-store" | "partner-tasks" | "announcements" | "withdrawals" | "contract" | "group-challenges" | "polls" | "adspage" | "settings" | "log";
...
const TAB_GROUPS: { label: string; tabs: { id: Tab; label: string; icon: React.ReactNode; badge?: string }[] }[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: "tiktok",       label: "TikTok",          icon: <span className="text-sm">🎵</span>,           badge: "جديد" },
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-[#0D0D0F] text-white overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto p-4 max-w-3xl mx-auto w-full">
        ...
        {tab === "tiktok"        && <AdminTikTokCampaigns />}
